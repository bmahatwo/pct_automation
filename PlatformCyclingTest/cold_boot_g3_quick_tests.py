...
if os.path.isdir(originalFolderWithCompletePath):
	...
	stringFolderName_NowTimeDate = str(currentIteration) + "_" + nowTimeDate.strftime("%d%m%Y_%H%M%S") + "_" + constants.STRING_COLD_BOOT_FROM_G3_QUICK
	...
	execute_save_compare.measure_time_between_each_iteration(constants.CONST_ITERATION_TIME_OF_COLD_BOOT_G3_QUICK, iterationFolderCompletePath)

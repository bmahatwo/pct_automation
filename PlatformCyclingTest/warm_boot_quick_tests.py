...
if os.path.isdir(originalFolderWithCompletePath):
	...
	stringFolderName_NowTimeDate = str(currentIteration) + "_" + nowTimeDate.strftime("%d%m%Y_%H%M%S") + "_" + constants.STRING_WARM_BOOT_QUICK
	...
	execute_save_compare.measure_time_between_each_iteration(constants.CONST_ITERATION_TIME_OF_WARM_BOOT_QUICK, iterationFolderCompletePath)
